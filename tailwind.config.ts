  ...
  theme: {
    ...
    extend: {
      ...
      animation: {
        ...
        'fade-in-up-fast': 'fadeInUp 0.5s ease-out 0.4s forwards', 
        'fade-in-up-normal': 'fadeInUp 0.6s ease-out 0.2s forwards', 
        'fade-in-up-slow': 'fadeInUp 0.8s ease-out forwards', 
        'fade-in-up-buttons': 'fadeInUp 0.7s ease-out 0.6s forwards',
      ...
      typography: (theme: (path: string) => string) => ({
        DEFAULT: {
          css: {
            ...
            // Dark mode handled by .dark variant below or prose-invert class
